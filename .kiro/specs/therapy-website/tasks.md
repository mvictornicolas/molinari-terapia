...
- [x] 1. Estrutura base do projeto e configuração
  ...
  - [x] 1.3 Configurar ambiente de testes (Vitest + fast-check)
...
- [x] 2. Implementar seções de conteúdo institucional
  - [x] 2.1 Implementar seção Hero/Início
  ...
  - [x] 2.2 Implementar seção "Sobre a Hipnoterapia"
  ...
  - [x] 2.3 Implementar seção "Sobre o Terapeuta"
  ...
  - [x] 2.4 Implementar seção "Público Atendido"
...
- [x] 3. Implementar navegação e scroll
  - [x] 3.1 Implementar header com menu de navegação fixo
  ...
  - [x] 3.2 Implementar scroll suave e destaque de seção ativa
  ...
  - [x] 3.3 Implementar animações de scroll e botão "voltar ao topo"
...
- [x] 4. Checkpoint — Verificar estrutura e navegação
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Implementar formulário de contato com WhatsApp
  - [x] 5.1 Criar formulário de contato (HTML + validação)
  ...
  - [x] 5.2 Implementar função `buildWhatsAppUrl` e redirecionamento
...
- [x] 6. Implementar integração com Cal.com (agendamento)
  - [x] 6.1 Incorporar widget Cal.com na seção de agendamento
  ...
  - [x] 6.2 Adicionar conteúdo informativo sobre agendamento e consultas remotas
...
- [x] 7. Implementar estilos responsivos e acessibilidade
  - [x] 7.1 Implementar design responsivo completo
  ...
  - [x] 7.2 Implementar acessibilidade WCAG 2.1 AA
...
- [x] 8. Implementar footer e documentação
  - [x] 8.1 Criar footer com informações legais
    - Criar `<footer>` com copyright, links úteis e informações de contato
    - Estilizar de forma consistente com o restante do site
    - _Requirements: 9.1_

  - [x] 8.2 Criar documentação de deploy (README.md)
...
- [x] 9. Otimização de performance
  - [x] 9.1 Otimizar carregamento e performance
